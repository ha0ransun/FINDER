...
class FINDER:
    ...
    def __init__(self):
        ...
        self.g_type = args.g_type #erdos_renyi, powerlaw, small-world， barabasi_albert
...
#################################################New code for FINDER#####################################
    ...
    def Train(self):
        ...
        for iter in range(MAX_ITERATION):
            ...
            if iter % 300 == 0:
                ...
                sys.stdout.flush()
                model_path = '%s/nrange_%d_%d_iter_%d_%s.ckpt' % (save_dir, NUM_MIN, NUM_MAX, iter, self.g_type)
    ...
    def HXA(self, g, method):
        ...
        Robustness = self.utils.getRobustness(self.GenNetwork(g), solution)
        return Robustness, sol